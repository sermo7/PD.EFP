...
import es.upm.miw.pd.flyweight.Componente;
import es.upm.miw.pd.flyweight.FactoriaCaracter;
import es.upm.miw.pd.flyweight.Parrafo;
import es.upm.miw.pd.flyweight.Texto;
